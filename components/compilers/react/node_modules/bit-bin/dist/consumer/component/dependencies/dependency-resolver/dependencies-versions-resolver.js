...
function updateDependenciesVersions(consumer, component) {
  ...
  function updateDependencies(dependencies) {
    dependencies.get().forEach(dependency => {
      const id = dependency.id; // $FlowFixMe component.componentFromModel is set
      ...
      for (const strategy of strategies) {
        ...
        if (strategyId) {
          ...
          _logger().default.debug(`found dependency version ${dependency.id.toString()} in strategy ${strategy.name}`);
  ...
  function getIdFromComponentConfig(componentId) {
    ...
    if (_ramda().default.isEmpty(dependencies)) return null;
