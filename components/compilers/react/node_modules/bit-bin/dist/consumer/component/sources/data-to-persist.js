...
class DataToPersist {
  ...
  persistAllToCapsule(capsule, opts = {
  ...
  _persistFilesToFS() {
    ...
    return (0, _bluebird().coroutine)(function* () {
      return _bluebird().default.map(_this3.files, file => file.write(), {
        concurrency: _constants().CONCURRENT_IO_LIMIT
      });
    })();
  }
  ...
  _persistSymlinksToFS() {
    ...
    return (0, _bluebird().coroutine)(function* () {
      return _bluebird().default.map(_this4.symlinks, symlink => symlink.write(), {
        concurrency: _constants().CONCURRENT_IO_LIMIT
      });
    })();
  }
