...
class ComponentConfig extends _abstractConfig().default {
  ...
  static load({
    ...
    return (0, _bluebird().coroutine)(function* () {
      ...
      componentConfig.componentHasWrittenConfig = packageJsonHasConfig || Boolean(bitJsonFile); // @ts-ignore seems to be a bug in ts v3.7.x, it doesn't recognize Promise.all array correctly
