...
class ComponentWriter {
  ...
  populateComponentsFilesToWrite() {
    var _this2 = this;
    ...
    return (0, _bluebird().coroutine)(function* () {
      ...
      yield _this2.populateFilesToWriteToComponentDir();
      return _this2.component;
    })();
  }

  populateFilesToWriteToComponentDir() {
    var _this3 = this;
    ...
    return (0, _bluebird().coroutine)(function* () {
      ...
      if (_this3.writeConfig && _this3.consumer) {
        const resolvedConfigDir = _this3.configDir || _this3.consumer.dirStructure.ejectedEnvsDirStructure;
        const configToWrite = yield _this3.component.getConfigToWrite(_this3.consumer, _this3.bitMap, resolvedConfigDir);
      ...
      if (_this3.writePackageJson && (_this3.isolated || _this3.consumer && _this3.consumer.isolated || _this3.writeToPath !== '.')) {
        const {
          packageJson,
          distPackageJson
        } = (0, _packageJsonUtils().preparePackageJsonToWrite)(_this3.bitMap, _this3.component, _this3.writeToPath, _this3.override, _this3.writeBitDependencies, _this3.excludeRegistryPrefix);
        ...
        componentConfig.compiler = _this3.component.compiler ? _this3.component.compiler.toBitJsonObject('.') : {};
        componentConfig.tester = _this3.component.tester ? _this3.component.tester.toBitJsonObject('.') : {};
        ...
        yield _this3._populateEnvFilesIfNeeded();
  ...
  _populateEnvFilesIfNeeded() {
    var _this4 = this;

    return (0, _bluebird().coroutine)(function* () {
      [_this4.component.compiler, _this4.component.tester].forEach(env => {
        if (!env) return;
        env.populateDataToPersist({
          configDir: _this4.writeToPath,
          consumer: _this4.consumer,
          deleteOldFiles: false,
          verbose: false,
          envType: env.envType
        });

        _this4.component.dataToPersist.merge(env.dataToPersist);
      });
      const areThereEnvFiles = _this4.component.compiler && !RA().isNilOrEmpty(_this4.component.compiler.files) || _this4.component.tester && !RA().isNilOrEmpty(_this4.component.tester.files);

      if (areThereEnvFiles && !_this4.writeConfig && !_this4.configDir && _this4.component.componentMap) {
        _this4.configDir = _constants().DEFAULT_EJECTED_ENVS_DIR_PATH;

        _this4.component.componentMap.setConfigDir(_this4.configDir);
      }
    })();
  }
  /**
    ...
    return (0, _bluebird().coroutine)(function* () {
      ...
      function () {
        var _ref = (0, _bluebird().coroutine)(function* () {
          ...
          // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
          const context = {
            componentDir: _this5.component.componentMap.getRootDir()
          };
          const compilerFromConsumer = _this5.consumer ? yield _this5.consumer.getEnv(_constants().COMPILER_ENV_TYPE, context) : null;
          const testerFromConsumer = _this5.consumer ? yield _this5.consumer.getEnv(_constants().TESTER_ENV_TYPE, context) : null;
          const compilerFromComponent = _this5.component.compiler ? _this5.component.compiler.toModelObject() : null;
          const testerFromComponent = _this5.component.tester ? _this5.component.tester.toModelObject() : null;
          return _envExtension().default.areEnvsDifferent(compilerFromConsumer ? compilerFromConsumer.toModelObject() : null, compilerFromComponent) || _envExtension().default.areEnvsDifferent(testerFromConsumer ? testerFromConsumer.toModelObject() : null, testerFromComponent);
        });
      ...
      if (_this5.component.componentMap.origin === _constants().COMPONENT_ORIGINS.AUTHORED && _this5.consumer) {
        _this5.consumer.config.overrides.updateOverridesIfChanged(_this5.component, (yield areEnvsChanged()));
      }
    })();
  }
  ...
  _handlePreviouslyNestedCurrentlyImportedCase() {
    ...
    return (0, _bluebird().coroutine)(function* () {
      if (!_this6.consumer) return; // $FlowFixMe this.component.componentMap is set
      // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!

      if (_this6.origin === _constants().COMPONENT_ORIGINS.IMPORTED && _this6.component.componentMap.origin === _constants().COMPONENT_ORIGINS.NESTED) {
        yield _this6._cleanOldNestedComponent();
        _this6.component.componentMap = _this6.addComponentToBitMap(_this6.writeToPath);
      }
    })();
  }
  /**
  ...
  _cleanOldNestedComponent() {
    ...
    return (0, _bluebird().coroutine)(function* () {
      if (!_this7.consumer) throw new Error('ComponentWriter._cleanOldNestedComponent expect to have a consumer'); // $FlowFixMe this function gets called when it was previously NESTED, so the rootDir is set
      // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
      // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!

      const oldLocation = path().join(_this7.consumer.getPath(), _this7.component.componentMap.rootDir);
      ...
      yield _this7._removeNodeModulesLinksFromDependents();

      _this7.bitMap.removeComponent(_this7.component.id);
    })();
  }
  ...
  _removeNodeModulesLinksFromDependents() {
    ...
    return (0, _bluebird().coroutine)(function* () {
      ...
      const directDependentIds = yield _this8.consumer.getAuthoredAndImportedDependentsIdsOf([_this8.component]);
      yield Promise.all(directDependentIds.map(dependentId => {
        const dependentComponentMap = _this8.consumer ? _this8.consumer.bitMap.getComponent(dependentId) : null;
        const relativeLinkPath = _this8.consumer ? (0, _componentNodeModulesPath().default)(_this8.consumer.config.bindingPrefix, _this8.component.id) : null;
        const nodeModulesLinkAbs = _this8.consumer && dependentComponentMap && relativeLinkPath ? _this8.consumer.toAbsolutePath(path().join(dependentComponentMap.getRootDir(), relativeLinkPath)) : null;
  ...
  _getConfigDir() {
    ...
    return new (_configDir().default)(_constants().DEFAULT_EJECTED_ENVS_DIR_PATH);
  }
