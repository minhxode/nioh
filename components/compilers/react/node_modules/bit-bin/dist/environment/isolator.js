...
class Isolator {
  ...
  isolate(componentId, opts) {
    ...
    return (0, _bluebird().coroutine)(function* () {
      ...
      const log = message => _loader().default.setText(`${loaderPrefix}: ${message}`); // @ts-ignore TODO: this should be part of the capsule interface


      _this.capsule.execNode =
      /*#__PURE__*/
      function () {
        var _ref = (0, _bluebird().coroutine)(function* (executable, args) {
          const onScriptRun = () => _loader().default.setText(`building component - ${componentId.name}`); // TODO: do this from the compiler/tester so that the isolator doesn't need to know if it's a builder/tester/*...


          yield (0, _librarian().runModule)(executable, {
            args,
            cwd: _this.dir,
            log,
            onScriptRun
      ...
      if (opts.shouldBuildDependencies) {
        ...
        /*#__PURE__*/
        function () {
          var _ref2 = (0, _bluebird().coroutine)(function* (dep) {
