...
export default class FixtureHelper {
    ...
    debugMode: boolean;
    npm: NpmHelper;
    constructor(fsHelper: FsHelper, commandHelper: CommandHelper, npmHelper: NpmHelper, scopes: ScopesData, debugMode: boolean);
    ...
    copyFixtureComponents(dir?: string, cwd?: string): void;
