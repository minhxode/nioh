...
class EnvExtension extends _baseExtension().default {
  ...
  reload(scopePath, context) {
    ...
    return (0, _bluebird().coroutine)(function* () {
      ...
      const throws = true;
      yield _superprop_getReload().call(_this3, scopePath, {
        throws
      }); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
  ...
  static load(props) {
    ...
    return (0, _bluebird().coroutine)(function* () {
      const baseExtensionProps = yield _superprop_getLoad().call(_this4, props);
  ...
  static loadFromModelObject(modelObject, repository) {
    var _superprop_getLoadFromModelObject = () => super.loadFromModelObject,
        _this5 = this;

    return (0, _bluebird().coroutine)(function* () {
      const baseExtensionProps = _superprop_getLoadFromModelObject().call(_this5, modelObject);
  ...
  static loadFromSerializedModelObject(modelObject) {
    var _superprop_getLoadFromModelObject2 = () => super.loadFromModelObject,
        _this6 = this;

    return (0, _bluebird().coroutine)(function* () {
      _logger().default.silly('env-extension, loadFromModelObject');

      const baseExtensionProps = _superprop_getLoadFromModelObject2().call(_this6, modelObject);
  ...
  static loadFromCorrectSource({
    ...
    return (0, _bluebird().coroutine)(function* () {
      ...
      if (overridesFromConsumer && overridesFromConsumer.env && overridesFromConsumer.env[envType]) {
        ...
        _logger().default.silly(`env-extension, loading ${envType} from the consumer config overrides`);
