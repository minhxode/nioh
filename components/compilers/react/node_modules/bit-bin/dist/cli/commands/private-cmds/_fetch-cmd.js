...
class Fetch extends _command().default {
  constructor(...args) {
    super(...args);
    ...
    (0, _defineProperty2().default)(this, "opts", [['n', 'no-dependencies', 'do not include component dependencies']]);
  }
  ...
  action([path, args], {
    ...
    return (0, _consumer().migrate)(scopePath, false).then(() => {
      return (0, _scope().fetch)(scopePath, payload, noDependencies, headers);
    });
  }

  report(componentObjects) {
    const components = _componentObjects().default.manyToString(componentObjects); // No need to use packCommand because we handle all the base64 stuff in a better way inside the ComponentObjects.manyToString


    return JSON.stringify((0, _utils().buildCommandMessage)(components, undefined, compressResponse));
  }
