...
let compressResponse; // eslint-disable-next-line @typescript-eslint/class-name-casing

class _Show extends _command().default {
  constructor(...args) {
    super(...args);
    (0, _defineProperty2().default)(this, "name", '_show <path> <args>');
    (0, _defineProperty2().default)(this, "private", true);
    (0, _defineProperty2().default)(this, "description", 'show a specific component on scope');
  ...
  action([path, args]) {
    ...
    (0, _checkVersionCompatibility().checkVersionCompatibilityOnTheServer)(headers.version); // validateVersion(headers)
    ...
    return (0, _consumer().migrate)(scopePath, false).then(() => {
      return (0, _scope().scopeShow)(scopePath, payload);
    });
  }
