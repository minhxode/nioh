...
class Latest extends _command().default {
  constructor(...args) {
    super(...args);
    (0, _defineProperty2().default)(this, "name", '_latest <path> <args>');
    (0, _defineProperty2().default)(this, "private", true);
    (0, _defineProperty2().default)(this, "description", 'latest version numbers of given components');
  ...
  action([path, args]) {
    ...
    return (0, _consumer().migrate)(scopePath, false).then(() => {
      return (0, _scope().latestVersions)(scopePath, payload);
    });
  }
