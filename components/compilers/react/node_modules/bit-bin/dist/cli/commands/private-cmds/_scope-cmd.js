...
class Prepare extends _command().default {
  constructor(...args) {
    super(...args);
    (0, _defineProperty2().default)(this, "name", '_scope <path> <args>');
    (0, _defineProperty2().default)(this, "description", 'describe a scope');
  ...
  action([path, args]) {
    ...
    return (0, _scope().describeScope)((0, _utils().fromBase64)(path));
  }

  report(scopeObj) {
    if ((0, _utils().empty)(scopeObj)) return '';
    return (0, _utils().packCommand)((0, _utils().buildCommandMessage)(scopeObj, undefined, compressResponse), true, compressResponse);
  }
