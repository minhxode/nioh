...
function _log() {
  const data = _interopRequireDefault(require("../../../api/scope/lib/log"));
...
class _Log extends _command().default {
  constructor(...args) {
    super(...args);
    (0, _defineProperty2().default)(this, "name", '_log <path> <args>');
    (0, _defineProperty2().default)(this, "private", true);
    (0, _defineProperty2().default)(this, "description", 'show component logs');
  ...
  action([path, args]) {
    ...
    return (0, _consumer().migrate)(scopePath, false).then(() => {
      return (0, _log().default)(scopePath, payload);
    });
  }
