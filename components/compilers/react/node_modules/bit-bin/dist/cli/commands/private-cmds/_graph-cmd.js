...
class _Graph extends _command().default {
  constructor(...args) {
    super(...args);
    (0, _defineProperty2().default)(this, "name", '_graph <path> <args>');
    (0, _defineProperty2().default)(this, "private", true);
    (0, _defineProperty2().default)(this, "description", 'returns scope graph or sub-graph when component id is given');
  ...
  action([path, args]) {
    ...
    return (0, _consumer().migrate)(scopePath, false).then(() => {
      return (0, _scope().graph)(scopePath, payload);
    });
  }
