...
/*#__PURE__*/
function () {
  var _show = (0, _bluebird().coroutine)(function* ({
    id,
    json,
    versions,
    remote,
    ...
    function getComponent(allVersions) {
      ...
      if (remote) {
        _loader().default.start(_loaderMessages().BEFORE_SHOW_REMOTE); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!


        return (0, _().getScopeComponent)(params);
      }

      return (0, _().getConsumerComponent)(_objectSpread({}, params, {
        compare
      }));
    }
  });
