...
function () {
  var _migrate = (0, _bluebird().coroutine)(function* (scopePath, verbose) {
    _logger().default.silly('migrate.migrate, starting migration process');
    ...
    if (scopePath) {
      _logger().default.silly(`migrate.migrate, running migration process for scope in path ${scopePath}`);
    ...
    _logger().default.silly('migrate.migrate, running migration process for scope in consumer');
